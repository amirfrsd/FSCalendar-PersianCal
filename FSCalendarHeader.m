...
@property (weak, nonatomic) FSCalendarHeaderCell *cell;
...
- (void)initialize
{
    ...
    collectionView.backgroundColor = [UIColor colorWithRed:36/255.0 green:136/255.0 blue:255/255.0 alpha:1];
...
- (void)layoutSubviews
{
    ...
    if (_needsAdjustingViewFrame) {
        ...
        _collectionView.frame = CGRectMake(0, self.fs_height*0.1-5.5, self.fs_width, self.fs_height);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    _cell.header = self;
    _cell.titleLabel.font = [UIFont fontWithName:IRANBold size:17];
    _cell.titleLabel.textColor = _appearance.headerTitleColor;
    _calendar.formatter.dateFormat = _appearance.headerDateFormat;
    NSLocale* locale = [[NSLocale alloc] initWithLocaleIdentifier:@"fa_IR"];
